...
barCenters = barplot(agged_favs$x, names.arg=c('Women Neutral', 'Women Confident', 'Men Neutral', 'Men Confindent'), main = 'Favorites vs. Confidence and Gender', ylab= 'log log favorite (mean)')
barCenters
se_favs
