...
barCenters = barplot(agged_favs$x, names.arg=c('Women Neutral', 'Women Confident', 'Men Neutral', 'Men Confident'), main = 'Favorites vs. Confidence and Gender', ylab= 'log log favorite (mean)')
barCenters
se_favs
...
```{r}
barplot(c(mean(one$tweet_favorite_count), mean(two$tweet_favorite_count)))
```
